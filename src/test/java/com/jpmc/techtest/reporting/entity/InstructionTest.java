...
public class InstructionTest {
	...
	public void constructorTest() {
		Instruction instruction = new Instruction("bar5", BuyOrSell.SELL, new BigDecimal("0.50"), "AED",
		...
		Assert.assertEquals(BuyOrSell.SELL, instruction.getBuyOrSell());
	...
	public void hoildaySettlementDateForAEDAndSARCurrencyTest() {
		Instruction instructionSAR = new Instruction("foo2", BuyOrSell.BUY, new BigDecimal("0.50"), "SAR",
				LocalDate.now(), LocalDate.of(2018, Month.AUGUST, 31), new Double(200), new BigDecimal("100.25"));
		Instruction instructionAED = new Instruction("bar2", BuyOrSell.SELL, new BigDecimal("0.50"), "AED",
				LocalDate.now(), LocalDate.of(2018, Month.SEPTEMBER, 1), new Double(200), new BigDecimal("100.25"));
		Instruction instructionNormalAED = new Instruction("bar2", BuyOrSell.SELL, new BigDecimal("0.50"), "AED",
	...
	public void hoildaySettlementDateForOtherCurrencyTest() {
		Instruction instructionUSD = new Instruction("foo2", BuyOrSell.BUY, new BigDecimal("1.00"), "USD",
				LocalDate.now(), LocalDate.of(2018, Month.SEPTEMBER, 1), new Double(200), new BigDecimal("100.25"));
		Instruction instructionSGP = new Instruction("foo", BuyOrSell.BUY, new BigDecimal("0.50"), "SGP",
				LocalDate.now(), LocalDate.of(2018, Month.SEPTEMBER, 2), new Double(200), new BigDecimal("100.25"));
		Instruction instructionNormalUSD = new Instruction("bar2", BuyOrSell.SELL, new BigDecimal("0.50"), "USD",
				LocalDate.now(), LocalDate.of(2018, Month.AUGUST, 30), new Double(200), new BigDecimal("100.25"));
	...
	public void USDAmountOfTradeTest() {
		Instruction instructionAED = new Instruction("bar", BuyOrSell.SELL, new BigDecimal("0.22"), "AED",
